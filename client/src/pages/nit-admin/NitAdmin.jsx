...
function SidebarNav({ isOpen }) {
    const Items = [
        { title: 'Nit Dashboard', icon: Shield, link: '/nit-admin/dashboard' },
        { title: 'Create Event', icon: Plus, link: '/nit-admin/create-event' },
        { title: 'Accomodation', icon: LocationEdit, link: '/nit-admin/accomodation' },
        { title: 'Teams', icon: LayoutList, link: '/nit-admin/teams' },
        { title: 'Events', icon: Trophy, link: '/nit-admin/events' },
        { title: 'Matches', icon: Calendar, link: '/nit-admin/matches' },
        { title: 'Leaderboard', icon: ChartColumn, link: '/nit-admin/leaderboard' },
    ];
